...
| 期間 | プロジェクト名 | 業務内容 | 役割 | 規模 |
|------|--------------|----------|------|------|
| 2025/05 - 現在 | AIエージェント開発 | Playwrightを用いたAIエージェント開発 | フルスタックエンジニア | - |
| 2024/04 - 2025/05 | LINEチャットボット開発 | LINE Webhook/LIFF開発、生成AI実装 | フルスタックエンジニア | - |
| 2023/08 - 2024/04 | 予算管理システムUIライブラリ | コンポーネントライブラリ開発 | フロントエンドデベロッパ | - |
| 2024/03 | 日記作成チャットボットPoC | 生成AI活用チャットボット開発 | フルスタックエンジニア | 3名 |
| 2019/01 - 2023/07 | Fintech Webサービス『paild』 | 新規立ち上げ、開発、チームマネジメント | FE開発者→EM→PdM | 3-8名 |
| 2018/10 - 2018/12 | 大規模Webサービスリファクタリング | リファクタリング・機能実装 | フロントエンドデベロッパ | - |
| 2018/08 - 2018/09 | サッカーコーチマッチングアプリ | 企画・設計・開発全般 | ディレクター/フルスタック開発者 | 2名 |
| 2016/02 - 2018/07 | B向けWebシステム開発（複数案件） | 受託・常駐開発 | プログラマ/フルスタック開発者 | 様々 |
